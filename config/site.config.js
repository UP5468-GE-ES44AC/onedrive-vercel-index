...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'laramiedep@laramiedep.onmicrosoft.com',
  ...
  title: "Sudoerz's ROM Download Station",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/romdownload/',
